...
const UpdateModal = ({info, open, close, header }) => {
  ...
  const handleSubmit = (e) => {
    ...
    const data = {
      ...
      dispatch(addIngredientUpdateAction(data));
      
      if (res?.addIngredientUpdate) {
    ...
    useEffect(() => {
        if (info) {
            setCount(info?.quantity);
            setStorage(info?.storage);
            setCreatedAt(info?.createdAt);
            setExpiredAt(info?.expirationAt);
        }
    }, [info])
              ...
              <Section>
                ...
                <Image src={info?.ingredientId.image} />
                          ...
                          <CenteTopTitleContainer>
                              <CenterTopCategoryName>{info?.ingredientId.category}</CenterTopCategoryName>
                              <CenterTopIngredientName>{info?.ingredientId.title}</CenterTopIngredientName>
                          </CenteTopTitleContainer>
                      </CenterTop>
